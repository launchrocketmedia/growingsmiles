...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="animate-pulse-ring fixed bottom-8 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green text-white shadow-float transition-transform hover:scale-110 sm:h-16 sm:w-16"
    >
